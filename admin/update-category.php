          ...
          if (mysqli_num_rows($result) > 0) {
              ...
              <form action=" $_SERVER['PHP_SELF']; ?>" method ="POST">
                  <div class="form-group">
                      <input type="hidden" name="cat_id"  class="form-control" value=" echo $row['category_id']; ?>">
                  </div>
                  <div class="form-group">
                      <label>category Name</label>
                      <input type="text" name="cat_name" class="form-control" value="echo $row['category_name']; ?>"  placeholder="" required>
                  </div>
