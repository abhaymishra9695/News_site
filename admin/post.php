          ...
          <div class="row">
              ...
              <table class="content-table">
                      ...
                      <?php
                        ...
                        $sql="SELECT post_id,title,category.category_name,post_date,user.username,post.category FROM post
                        LEFT JOIN category ON post.category=category.category_id
                        LEFT JOIN user ON post.author=user.user_id ORDER BY post_id LIMIT {$offset},{$limit}";
